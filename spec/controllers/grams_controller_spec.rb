...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy" do
    it "should not allow users who didn't create the gram to destroy" do
    ...
    it "should not allow unauthenticated users destory a gram" do
      p = FactoryGirl.create(:gram)
      delete :destroy, id: p.id
  ...
  describe "grams#update" do 
    it "should not let users who didn't create the gram to upload it" do
      p = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
    ...
    it "should have a 404 error if the grams cannot be found" do
      u = FactoryGirl.create(:user)
      sign_in u
  ...
  describe "grams#edit action" do
    ...
    it "should not allow authenticated users edit the gram" do
      p = FactoryGirl.create(:gram)
      get :edit, id: p.id
      expect(response).to redirect_to new_user_session_path
    end
